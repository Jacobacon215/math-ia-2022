def draw(           # this is the main function. it's best practice to program within a function rather than write everything globally. everything in this program is inside of draw().
    ...
    numFace=14,        # sets the default number of face cards to 14 (4 jacks + 4 queens + 4 kings + 2 jokers) but allows the parameter to be modified for flexibility
    numOther=40,    # sets the default number of other cards to 40 but allows the parameter to be modified for flexibility
    selectCard:str=None # allows the function to draw a predetermined card when prompted. default is to draw a random card.
    ...
    class Card:
        def __init__(self, card:str, numCard:int) -> None: # initializes Card class
    ...
    other, face = Card('other', numOther), Card('face', numFace)
    ...
    def drawCard() -> Card: # this function simulates drawing a card and returns the corresponding Card object.
        ...
        try:
            ...
            for activeCard in [other, face]: # the list is ordered like this [other, queen, king, ace, joker] because it corresponds to the graphic this way
    ...
    return drawnCard, deck, numFace, numOther
